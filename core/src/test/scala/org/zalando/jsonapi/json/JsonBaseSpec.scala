...
import org.zalando.jsonapi.{JsonapiRootObjectWriter, JsonapiRootObjectReader, Jsonapi}

trait JsonBaseSpec[JsonBaseType] extends WordSpec with MustMatchers {
  protected def parseJson(jsonString: String): JsonBaseType

  implicit val writer: JsonapiRootObjectWriter[JsonBaseType]
  implicit val reader: JsonapiRootObjectReader[JsonBaseType]

  protected lazy val rootObjectWithAttributesJson = parseJson(rootObjectWithAttributesJsonString)
  ...
  protected lazy val rootObjectWithAttributesJsonString =
    """
      |{
      |  "data": {
      |    "type": "mandatory",
  ...
  protected lazy val rootObjectWithAttributes: RootObject =
    RootObject(
  ...
  "JsonapiFormat" when {
    "serializing Jsonapi" must {
      "transform attributes correctly" in {
        Jsonapi.fromRootObject(rootObjectWithAttributes) mustEqual rootObjectWithAttributesJson
      }
      "transform resource object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjectWithoutAttributes) mustEqual rootObjectWithResourceObjectWithoutAttributesJson
      }
      "transform a list of resource objects correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjects) mustEqual rootObjectWithResourceObjectsJson
      }
      "transform resource identifier object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceIdentifierObject) mustEqual rootObjectWithResourceIdentifierObjectJson
      }
      "transform a list of resource identifier objects correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceIdentifierObjects) mustEqual rootObjectWithResourceIdentifierObjectsJson
      }
      "transform all string link types correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjectsWithAllLinksAsStrings) mustEqual rootObjectWithResourceObjectsWithAllLinksAsStringsJson
      }
      "transform all object link types correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjectsWithAllLinksAsObjects) mustEqual rootObjectWithResourceObjectsWithAllLinksAsObjectsJson
      }
      "transform all string and object link types correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjectsWithAllLinksAsStringsAndObjects) mustEqual rootObjectWithResourceObjectsWithAllLinksAsStringsAndObjectsJson
      }
      "transform all meta object inside resource object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithResourceObjectsWithMeta) mustEqual rootObjectWithResourceObjectsWithMetaJson
      }
      "transform a meta object in root object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithMeta) mustEqual rootObjectWithMetaJson
      }
      "transform error object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithErrorsObject) mustEqual rootObjectWithErrorsJson
      }
      "transform error object without links and meta and source correctly" in {
        Jsonapi.fromRootObject(rootObjectWithErrorsNoneObject) mustEqual rootObjectWithErrorsNoneJson
      }
      "transform included object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithIncluded) mustEqual rootObjectWithIncludedJson
      }
      "transform jsonapi object correctly" in {
        Jsonapi.fromRootObject(rootObjectWithJsonApiObject) mustEqual rootObjectWithJsonApiObjectJson
      }
      "transform relationship object correctly" in {
        Jsonapi.fromRootObject(RootObjectWithRelationships) mustEqual rootObjectWithRelationshipsJson
      }
      "transform empty relationship object correctly" in {
        Jsonapi.fromRootObject(resourceObjectWithEmptyRelationshipsObject) mustEqual resourceObjectWithEmptyRelationshipsJson
      }
    }
    "deserializing Jsonapi" must {
      "transform attributes correctly" in {
        Jsonapi.asRootObject(rootObjectWithAttributesJson) mustEqual rootObjectWithAttributes
      }
      "transform resource object correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectWithoutAttributesJson) mustEqual rootObjectWithResourceObjectWithoutAttributes
      }
      "transform a list of resource objects correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectsJson) mustEqual rootObjectWithResourceObjects
      }
      "transform resource identifier object correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceIdentifierObjectJson) mustEqual rootObjectWithResourceIdentifierObject
      }
      "transform a list of resource identifier objects correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceIdentifierObjectsJson) mustEqual rootObjectWithResourceIdentifierObjects
      }
      "transform all string link types correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectsWithAllLinksAsStringsJson) mustEqual rootObjectWithResourceObjectsWithAllLinksAsStrings
      }
      "transform all object link types correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectsWithAllLinksAsObjectsJson) mustEqual rootObjectWithResourceObjectsWithAllLinksAsObjects
      }
      "transform all string and object link types correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectsWithAllLinksAsStringsAndObjectsJson) mustEqual rootObjectWithResourceObjectsWithAllLinksAsStringsAndObjects
      }
      "transform all meta object inside resource object correctly" in {
        Jsonapi.asRootObject(rootObjectWithResourceObjectsWithMetaJson) mustEqual rootObjectWithResourceObjectsWithMeta
      }
      "transform a meta object in root object correctly" in {
        Jsonapi.asRootObject(rootObjectWithMetaJson) mustEqual rootObjectWithMeta
      }
      "transform error object correctly" in {
        Jsonapi.asRootObject(rootObjectWithErrorsJson) mustEqual rootObjectWithErrorsObject
      }
      "transform error object without links and meta and source correctly" in {
        Jsonapi.asRootObject(rootObjectWithErrorsNoneJson) mustEqual rootObjectWithErrorsNoneObject
      }
      "transform included object correctly" in {
        Jsonapi.asRootObject(rootObjectWithIncludedJson) mustEqual rootObjectWithIncluded
      }
      "transform jsonapi object correctly" in {
        Jsonapi.asRootObject(rootObjectWithJsonApiObjectJson) mustEqual rootObjectWithJsonApiObject
      }
      "transform relationship object correctly" in {
        Jsonapi.asRootObject(rootObjectWithRelationshipsJson) mustEqual RootObjectWithRelationships
      }
      "transform empty relationship object correctly" in {
        Jsonapi.asRootObject(resourceObjectWithEmptyRelationshipsJson) mustEqual resourceObjectWithEmptyRelationshipsObject
      }
    }
  }
}
